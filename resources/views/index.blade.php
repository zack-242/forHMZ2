...
<div class="mydiv">
  <div class="pagination_pos" style="text-align:left; margin:0px auto 0px auto; display:inline-block;">
    ...
    <div class="card card-3 bg-warning" style="">
      ...
      <br>
       <label>
        <input type="checkbox" class="option-input  checkbox" type="checkbox" value="hide" name="NOM" onchange="hide_show_table(this.id);" id="name_col" ;"/>Nom
      </label>
      <label>
        <input type="checkbox" class="option-input checkbox" type="checkbox" value="hide"  name="PRENOM" onchange="hide_show_table(this.id);" id="prenom_col" "/>Prenom
      </label>
      <label>
